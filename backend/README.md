...
## Project Structure
    ...
    ├── find_nearby_restaur_44323  # Django project configurations
...
1. Clone this repo and `cd find_nearby_restaur_44323`
...
2. Clone this repo and `cd find_nearby_restaur_44323`
